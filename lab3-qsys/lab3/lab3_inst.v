	lab3 u0 (
		...
		.plazer_0_conduit_end_CLK        (<connected-to-plazer_0_conduit_end_CLK>),        // plazer_0_conduit_end.CLK
		.plazer_0_conduit_end_HS         (<connected-to-plazer_0_conduit_end_HS>),         //                     .HS
		.plazer_0_conduit_end_VS         (<connected-to-plazer_0_conduit_end_VS>),         //                     .VS
		.plazer_0_conduit_end_BLANK_n    (<connected-to-plazer_0_conduit_end_BLANK_n>),    //                     .BLANK_n
		.plazer_0_conduit_end_SYNC_n     (<connected-to-plazer_0_conduit_end_SYNC_n>),     //                     .SYNC_n
		.plazer_0_conduit_end_G          (<connected-to-plazer_0_conduit_end_G>),          //                     .G
		.plazer_0_conduit_end_B          (<connected-to-plazer_0_conduit_end_B>),          //                     .B
		.plazer_0_conduit_end_R          (<connected-to-plazer_0_conduit_end_R>)           //                     .R
	);
